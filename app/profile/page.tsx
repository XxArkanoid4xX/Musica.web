...
export default function ProfilePage() {
  ...
  // Hydration safety for zustand (optional but good practice, though we skip for MVP speed if using simple hooks)
    ...
    <div className="flex flex-col space-y-8 pb-10">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-end gap-6 p-6 rounded-xl bg-white/5 border border-white/10">
        ...
        <div className="flex flex-col items-center md:items-start mb-2">
            ...
            <h1 className="text-4xl md:text-5xl font-black font-heading mb-2">{profile.name}</h1>
            <p className="text-white/70 font-medium mb-4">{profile.description}</p>
